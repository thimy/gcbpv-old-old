...
Payor.destroy_all
5.times do |i|
  Payor.create!(id: i+1, last_name: "Payor", first_name: "#{i + 1}", mail: "payor@mail.com", street_address: "Adresse", postcode: rand(10000..97000), city: "City")
end

10.times do |i|
  Student.create!(id: i+1, last_name: "Student", first_name: "#{i + 1}", payor_id: 1)
end

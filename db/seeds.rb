...
availabilities = [
  {
    ...
    teacher_id: 1,
    city_id: 1,
    start_time: Time.strptime("01/01/2000 16:00", "%H:%M"),
    end_time: Time.strptime("01/01/2000 21:00", "%H:%M"),
  }
]
